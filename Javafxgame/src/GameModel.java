...
public class GameModel {
	...
	public String move(int steps) {
		...
		for (int i = 0; i < steps; i++) {
			...
			if (getPlayerAt(obstruction.getRow(), obstruction.getColumn()) != null && i == steps - 1) {
				// the next cell has a player and it's the last step.
				// 2 players cannot be in same grid.
				continue;
			}

			if (obstruction instanceof TeleporterObstruction && i == steps - 1) {
